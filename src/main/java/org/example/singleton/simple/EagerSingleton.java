 ...
 * so when the program starts the object is created whether it is used or not. <br>
 * 1. Create an object field that has the class object initialized already.<br>
 * 2. Create Private CONSTRUCTOR of the class so that no one else can create an object through the constructor. <br>
 * 3. Then create a FACTORY METHOD that just returns the object field that we created on our first step. <br>
